                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <p>
                            ...
                            <img src="{{ asset('img/default-avatar.png') }}" alt="Project Image" class="img-circle"
                                width="30" height="30">
                            {{ isset(Auth::guard('users')->user()->name) ? Auth::guard('users')->user()->name : 'N/A' }}
                            <b class="caret"></b>
                        </p>
                    </a>
                    <ul class="dropdown-menu">
                        <li> <a href="{{ route('users.dashboard.profile') }}">
                                <p>Account</p>
                            </a></li>
                        ...
                        <li>
                            <a href="{{ route('auth.userLogout') }}" onclick="return confirmLogout(event);">
                                <p>Log out</p>
                            </a>
                        </li>
